...
async def test_raises_when_moving_to_restricted_slots_while_shaking(
    ...
    heater_shaker_data = [
        HeaterShakerMovementRestrictors(
            plate_shaking=True, latch_closed=True, deck_slot=5, module_id="module-id"
        )
    ]
...
async def test_raises_when_moving_to_restricted_slots_while_latch_open2(
    ...
    heater_shaker_data = [
        HeaterShakerMovementRestrictors(
            plate_shaking=False, latch_closed=False, deck_slot=5, module_id="module-id"
        )
    ]
...
def test_raises_on_restricted_movement_with_multi_channel(
    ...
    heater_shaker_data = [
        HeaterShakerMovementRestrictors(
            plate_shaking=False, latch_closed=True, deck_slot=5, module_id="module-id"
        )
    ]
